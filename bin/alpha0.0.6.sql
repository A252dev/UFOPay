...
--
-- Table structure for table `B2BBalance`
--

DROP TABLE IF EXISTS `B2BBalance`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `B2BBalance` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `userId` int(11) NOT NULL,
  `b2bAccess` tinyint(1) NOT NULL,
  `b2b_balance_usd` double NOT NULL,
  `b2b_balance_eur` double NOT NULL,
  `b2b_balance_pln` double NOT NULL,
  `b2b_balance_rub` double NOT NULL,
  `kassaId` int(11) NOT NULL DEFAULT 0,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `B2BBalance`
--

LOCK TABLES `B2BBalance` WRITE;
/*!40000 ALTER TABLE `B2BBalance` DISABLE KEYS */;
INSERT INTO `B2BBalance` VALUES
(1,534363,1,6,0,0,0,34718);
/*!40000 ALTER TABLE `B2BBalance` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `B2BKassa`
--

DROP TABLE IF EXISTS `B2BKassa`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `B2BKassa` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `userId` int(11) NOT NULL,
...
--
-- Dumping data for table `B2BKassa`
--

LOCK TABLES `B2BKassa` WRITE;
/*!40000 ALTER TABLE `B2BKassa` DISABLE KEYS */;
INSERT INTO `B2BKassa` VALUES
(1,534363,'text.org','dafa','mail.com','CONFIRMED','4796FCI5UZ',34718,'dfjgdfjlhgfjdkg');
/*!40000 ALTER TABLE `B2BKassa` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `B2Bwithdraw`
--

DROP TABLE IF EXISTS `B2Bwithdraw`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `B2Bwithdraw` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `userId` int(11) NOT NULL,
...
--
-- Dumping data for table `B2Bwithdraw`
--

LOCK TABLES `B2Bwithdraw` WRITE;
/*!40000 ALTER TABLE `B2Bwithdraw` DISABLE KEYS */;
/*!40000 ALTER TABLE `B2Bwithdraw` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `BusinessBills`
--

DROP TABLE IF EXISTS `BusinessBills`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `BusinessBills` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `kassaId` int(11) NOT NULL,
  ...
  `currency` longtext NOT NULL,
  `apiKey` longtext NOT NULL,
  `paymentData` datetime(6) NOT NULL DEFAULT '0001-01-01 00:00:00.000000',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `BusinessBills`
--

LOCK TABLES `BusinessBills` WRITE;
/*!40000 ALTER TABLE `BusinessBills` DISABLE KEYS */;
INSERT INTO `BusinessBills` VALUES
(1,34718,-1560347457,0,'CREATED',10,'USDT','dfjgdfjlhgfjdkg','0001-01-01 00:00:00.000000'),
(2,34718,1545956995,0,'CREATED',10,'USDT','dfjgdfjlhgfjdkg','0001-01-01 00:00:00.000000'),
(3,34718,-579753964,534363,'PAID',10,'USD','dfjgdfjlhgfjdkg','0001-01-01 00:00:00.000000');
/*!40000 ALTER TABLE `BusinessBills` ENABLE KEYS */;
UNLOCK TABLES;
...
(20,534363,'USD','EUR',20,'UGYK91BNHX','PENDING'),
(21,534363,'PLN','RUB',100,'F6MGE6IP1H','PENDING');
...
(1,534363,'Adam','Grochowski','adam@mail.pl','12345','12345','2023-08-25 21:06:27.487373','2023-08-10','NONE',20,38.65,2224.38,1000,0,1,1),
...
(9,534363,'USD','131',10,'SUCCESS','2023-09-19 14:38:05.133284'),
(10,534363,'USD','131',10,'B2BSUCCESS','2023-09-19 15:13:01.428206'),
(11,534363,'USD','131',4,'B2BSUCCESS','2023-09-19 15:21:34.385158');
...
('20230917122943_init11','7.0.10'),
('20230918145425_init12','7.0.10'),
('20230918151219_init13','7.0.10'),
('20230918183642_init14','7.0.10'),
('20230918222931_init15','7.0.10'),
('20230919004210_init16','7.0.10'),
('20230919124101_init17','7.0.10'),
('20230919132102_init18','7.0.10');
...
-- Dump completed on 2023-09-20  3:38:14
